...
>>>>> �ļ�˵����
	*
	*	1.ASCII�ַ���: !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
	*	2.ASCII��ģ���ܹ���5�ִ�С����ģ��3216��2412��2010��1608��1206����������
	*	3.������ģҲ�����ִ�С��3232��2424��2020��1616��1212
	*	4.�����ֿ���С�ֿ⣬Ҳ�����õ�����Ӧ�ĺ�����ȡģ
	*	5.�����ֿ�ÿ����ģ���涼����Ҫ��һ����Ӧ�ĺ�����Ϊ����
	*
>>>>> ȡģ��ʽ˵����
...
// ������ģ���ݣ�����Ϊ1212
// ��������ģʱ��һ��Ҫ�����������һά�Ĵ�С���û��ɸ����������е���
//	���ı����ź�Ӣ�ı������ǲ�һ���ģ����û�ж����ı����Ž���ȡģ����ʾʱҪ��Ӣ�������㣬ʹ��ASCII����ģ
// ÿ����ģ���涼����Ҫ��һ����Ӧ�ĺ�����Ϊ����
//
const uint8_t  Chinese_1212[50][24]=	
{ 
//  ��(0) ��(1) ��(2) ��(3) ��(4) ��(5) ��(6) ��(7) ��(8)
	{0x00,0x00,0x00,0x00,0x00,0x00,0x20,0x00,0xFE,0x03,0x22,0x02,0x22,0x02,0xFE,0x03,0x20,0x00,0x20,0x00,0x00,0x00,0x00,0x00},{"��"},/*0*/	
	{0x00,0x00,0x00,0x00,0x00,0x00,0x60,0x00,0xFF,0x07,0x04,0x01,0x88,0x00,0x50,0x00,0x78,0x00,0x87,0x07,0x00,0x00,0x00,0x00},{"��"},/*1*/	                                                                                                                   
	{0x00,0x00,0x00,0x00,0x00,0x00,0x60,0x00,0xFE,0x07,0xF8,0x01,0xC0,0x00,0xFE,0x07,0x20,0x00,0x38,0x00,0x00,0x00,0x00,0x00},{"��"},/*2*/	                                                                                                                       
	{0x00,0x00,0x00,0x00,0x88,0x00,0x84,0x00,0xF4,0x07,0xC6,0x01,0xA6,0x01,0x94,0x02,0xEC,0x05,0x84,0x00,0x00,0x00,0x00,0x00},{"��"},/*3*/	                                                                                                                       
	...
	{0x00,0x00,0x00,0x00,0x00,0x00,0xFC,0x07,0x04,0x00,0xFC,0x03,0x14,0x02,0xA4,0x01,0x66,0x00,0x9E,0x07,0x00,0x00,0x00,0x00},{"��"},/*5*/	                                                                                                                       
...
// �ı���ʾ������ʾ���ĺ��ַ����û��ɸ���������ֿ����������ɾ���壺���ͿƼ�
	...
	{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFC,0xFF,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFF,0x00,0x30,0x00,0x20,0x30,0x04,0x30,0x30,0x0C,0x38,0x30,0x18,0x18,0x30,0x30,0x0C,0x30,0x60,0x06,0x30,0xC0,0x02,0x30,0x80,0x00,0x30,0x00,0x80,0x1F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},{"ʾ"},/*7*/
	...
	{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xC0,0xFC,0xFC,0xC0,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xFF,0xFF,0xCF,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0xC0,0xC6,0xC6,0xC0,0xFE,0xC6,0xC0,0x03,0xFB,0x7C,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},{"ɾ"},/*29*/
...
/*	
	*	1.����ΪASCII��ģ����
	*	2.ASCII�ַ���: !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
	*	3.ASCII��ģ�����壬�ܹ���5�ִ�С����ģ��3216��2412��2010��1608��1206
*/
/*********************************************************************************************************************************************************************************************************************************************FANKE*****/
