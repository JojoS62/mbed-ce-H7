...
int main()
{
    ...
    double sd_size_MB = bd.size() / (double)(1UL << 30);
    printf("SD size: %lld Byte (%.3f GB) read size: %lld Byte\n\n", bd.size(), sd_size_MB, bd.get_read_size());
